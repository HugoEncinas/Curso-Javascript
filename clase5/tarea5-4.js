...
function get_number() {
  ...
  // maxRange = document.getElementById("max-inpt").value;
  // minRange = document.getElementById("min-inpt").value;
  // inpt.value = "";
  main();
}
...
inpt.setAttribute("placeholder", "Number of elements");
inpt.setAttribute("id", "number-inpt");
